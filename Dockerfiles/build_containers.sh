...
docker build -t gpu_base -f Dockerfile.gpu_base .

# Build sciml_base image using gpu_base as base
echo "Building sciml_base image..."
docker build -t sciml_base -f Dockerfile.sciml_base .
...
docker build -t synthetic_regression -f Dockerfile.synthetic_regression .
